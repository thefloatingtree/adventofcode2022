...
def perform_instruction(crate_stacks, instruction):
    ...
    flipped_grabbed_crates = []
    for _ in range(pop_count):
        flipped_grabbed_crates.append(crate_stacks[from_index].pop())
    grabbed_crates = reversed(flipped_grabbed_crates)
    crate_stacks[to_index].extend(grabbed_crates)

...
with open('input.txt') as file:
    ...
    directories_under_size_limit_sum = 0
    for directory in root_directory.flatten():
        if directory.size <= 100000:
            directories_under_size_limit_sum += directory.size

    print(directories_under_size_limit_sum)
